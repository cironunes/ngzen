...
Creator.prototype.directive = function directive(name, moduleName) {
  var fileFolder = _getFileFolder(moduleName);
...
Creator.prototype.constant = function constant(name, moduleName) {
  var fileFolder = _getFileFolder(moduleName);

  _createFolder(fileFolder);
  _createFiles(['constant'], {
    name: name,
    moduleName: moduleName,
    constructorName: name + 'Constant'
  }, fileFolder);
}
